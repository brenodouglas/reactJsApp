			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'div',
							{ className: 'col-md-7 col-sm-offset-2', style: { marginTop: 15 } },
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							...
							_react2['default'].createElement('input', { type: 'text', className: 'form-control', ref: 'username', placeholder: 'search username' })
						),
						_react2['default'].createElement(
							'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var base = _reBase2['default'].createClass('https://popping-heat-9461.firebaseio.com');
				...
				return _react2["default"].createElement(
					...
					_react2["default"].createElement(
						...
						bio.avatar_url && _react2["default"].createElement(
							...
							" ",
							_react2["default"].createElement("img", { src: bio.avatar_url, className: "img-responsive" })
						),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Helpers = (function () {
		...
		_createClass(Helpers, [{
			key: 'getRepos',
			value: function getRepos(username) {
				return _axios2['default'].get('https://api.github.com/users/' + username + '/repos');
			}
		}, {
			key: 'getUserInfo',
			value: function getUserInfo(username) {
				return _axios2['default'].get('http://api.github.com/users/' + username);
			}
		}], [{
			key: 'getGithubInfo',
			value: function getGithubInfo(username) {
				var instance = new Helpers();

				return _axios2['default'].all([instance.getRepos(username), instance.getUserInfo(username)]).then(function (arr) {
					return {
						repos: arr[0].data,
						bio: arr[1].data
					};
